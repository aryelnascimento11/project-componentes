export default function Header() {
    return(
        ...
        <nav className='flex'>
          ...
          <button className='group/enter text-blue-500 flex gap-2 ml-10 rounded-2xl border border-blue-500 shadow-lg px-3 py-1 font-light'>Entrar
        ...
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" className="text-2xl group-hover/enter:text-rose-500 group-hover/enter:bg-black rounded-full transition" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M16 8A8 8 0 1 0 0 8a8 8 0 0 0 16 0zm-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11.5z"></path></svg>
        </button>
        </nav>
      </header>
    )
